 ...
 * @author Marcos
 */
public class Suspeitos extends javax.swing.JFrame {
  ...
  Integer posicaoLista;
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
            ...
            jogo.setNome(txtNomesuspeito.getText());
    ...
    public static void main (String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Suspeitos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
