 ...
 * @author Marcos
 */
public class Detetive extends javax.swing.JFrame {
  ...
  Integer posicaoLista;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Detetive.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
